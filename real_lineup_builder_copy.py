...
class EnhancedProjectionsNBAData:
    ...
    def calculate_enhanced_projection(self, player, recent_games, position, team, dk_salary_info):
        """Calculate enhanced fantasy projection with minutes, pace, usage rate, and points per minute"""
        try:
            ...
            # Calculate projected minutes (with usage rate consideration)
            projected_minutes = self.project_minutes(avg_stats['minutes'], recent_games, team, usage_rate)
            ...
            # Calculate pace-adjusted and usage-adjusted per-36 stats
            pace_adjusted_stats = {}
            ...
            for stat in scoring_stats:
                pace_adjusted_stats[stat] = per_36_stats[stat] * pace_adjustment * usage_adjustment
    ...
    def project_minutes(self, recent_minutes, recent_games, team, usage_rate=None):
        """Project minutes for tonight's game with usage rate consideration"""
...
class EnhancedProjectionsNBAOptimizer:
    ...
    def build_lineups(self):
        ...
        print("Using minutes projections, pace adjustments, usage rate, and efficiency metrics")
        print("=" * 60)
...
if __name__ == "__main__":
    ...
    print("With minutes projections, pace adjustments, usage rate, and efficiency metrics")
    print()
